...
HD_PWD='C:/Users/Ctrend.pk/project 1/project 1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3.tcl -notrace
