...
HD_PWD='C:/Users/Ctrend.pk/project 1/project 1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3.tcl
